...
public class RoomRepository {
    ...
    public List<RoomShortResponseDto> getAllRooms(RoomFilter filter) {
        ...
        String sql = "SELECT r.room_id AS id, r.room_number AS number, r.price_per_day AS pricePerDay, r.phone_number AS phoneNumber, " +
                ...
                "FROM rooms AS r " +
                "JOIN room_types AS rt ON r.room_type_id = rt.room_type_id " +
                "WHERE 1=1 ";
        ...
        MapSqlParameterSource params = new MapSqlParameterSource("floor", filter.getFloor())
                .addValue("roomTypeId", filter.getRoomTypeId())
                .addValue("isAvailable", filter.getIsAvailable());
    ...
    public Optional<RoomTypeResponseDto> getRoomTypeById(long roomTypeId) {
        //language=PostgreSQL
        String sql = "SELECT room_type_id AS id, room_type AS type, initial_price_per_day AS pricePerDay FROM room_types WHERE room_type_id = :roomTypeId ";
    ...
    public List<RoomTypeResponseDto> getAllRoomTypes() {
        //language=PostgreSQL
        String sql = "SELECT room_type_id AS id, room_type AS type, initial_price_per_day AS pricePerDay FROM room_types ";
